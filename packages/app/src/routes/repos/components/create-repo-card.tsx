...
export const CreateRepoCard = () => {
  ...
  return (
    <>
      <div
        className="rounded-xl group border-2 border-dashed border-border grid place-items-center cursor-pointer hover:border-muted-foreground transition-colors"
