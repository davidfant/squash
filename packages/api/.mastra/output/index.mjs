...
const createQualifyAgent = (databaseUrl) => {
  return new Agent({
    name: "Qualify Agent",
    instructions: "You are a helpful assistant that can help with qualifying leads. You are given a lead and you need to qualify them.",
...
const mastra = new Mastra({
  agents: {
    qualifyAgent: createQualifyAgent()
  }
});
