...
export const CreateRepoCard = () => {
  ...
  return (
    <>
      <div
        className="aspect-[270/226] rounded-xl group border-2 border-dashed border-border grid place-items-center cursor-pointer hover:border-muted-foreground transition-colors"
